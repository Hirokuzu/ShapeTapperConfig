...
def main():
    ...
    for block in range(0,num_blocks):
        for trial_num in range(0,num_trials):
            ...
            image_2 = solo_files[randrange(0,len(solo_files))]
            ...
            while (get_cartesian_distance(pos_img_1_x,pos_img_1_y,pos_img_2_x,pos_img_2_y) < (img_1_diag + img_2_diag)/2): #while the image distances overlap
...
def get_solo_imgs(directory):
    return [x for x in os.listdir(directory) if re.match('^rectangle[0-9]*.png$', x)]
